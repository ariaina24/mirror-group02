...
class index:
    def GET(self):
        ...
        result +=  '<li class="nav-item"><a class="nav-link" href="#">Artist</a></li><li class="nav-item"><a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Liste de genre</a></li><li class="nav-item"><a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Employee</a></li><li class="nav-item"><a class="nav-link" href="#">Invoice</a></li><li class="nav-item"><a class="nav-link" href="#">InvoiceLine</a></li><li class="nav-item"><a class="nav-link" href="#">MediaType</a></li><li class="nav-item"><a class="nav-link" href="#">Playlist</a></li>'
